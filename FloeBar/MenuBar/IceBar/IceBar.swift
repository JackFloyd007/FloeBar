...
private struct IceBarContentView: View {
    ...
    private var content: some View {
        if !ScreenCapture.cachedCheckPermissions() {
            HStack {
                Text("The Floe Bar requires screen recording permission.")
            ...
            Text("FloeBar cannot display menu bar items for automatically hidden menu bars")
                .padding(.horizontal, 10)
