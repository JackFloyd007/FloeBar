...
struct GeneralSettingsPane: View {
    ...
    private var showIceIcon: some View {
        Toggle("Show FloeBar icon", isOn: $settings.showIceIcon)
            .annotation("Click to show hidden menu bar items. Right-click to access FloeBar settings.")
    }

    @ViewBuilder
    private var iceIconPicker: some View {
        let labelKey = LocalizedStringKey("FloeBar icon")
